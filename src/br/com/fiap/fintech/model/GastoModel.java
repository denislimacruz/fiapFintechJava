...
public class GastoModel {
	...
	public GastoModel(int cd_usuario, int cd_gasto, double vl_valor, Calendar dt_data, String ds_categoria,
			String ds_descricao) {
		super();
	...
	public int getCd_gasto() {
		return cd_gasto;
	}
	public void setCd_gasto(int cd_gasto) {
		this.cd_gasto = cd_gasto;
	}
	...
	public String toString() {
		...
		return "GastoModel [cd_usuario=" + cd_usuario + ", cd_gasto=" + cd_gasto + ", vl_valor=" + vl_valor
